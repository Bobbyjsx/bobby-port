...
export const Project = ({ project }: Props) => {
	const { name, description, image, githubLink, liveURL, stack } =
		project 
	return (
		<section className="mx-auto w-full flex justify-center items-center h-screen overflow-y-scroll">
			<div className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6 ">
				...
				<div className="mt-5 sm:mt-6 flex sm:flex-row flex-col sm:gap-3 w-full">
					{githubLink && (
						<Link
