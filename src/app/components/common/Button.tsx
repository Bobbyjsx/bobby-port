...
const buttonStyles = cva(
	"flex justify-center rounded-md px-3 py-1.5 text-sm font-medium leading-6 shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2",
	{
		defaultVariants: {
			intent: "primary",
		},
		variants: {
			intent: {
				neutral:
					"border border-indigo-500 hover:bg-gray-100 bg-white text-zinc-800  duration-300 delay-150 text-lg  focus-visible:outline-purple-600 p-6",
				primary:
